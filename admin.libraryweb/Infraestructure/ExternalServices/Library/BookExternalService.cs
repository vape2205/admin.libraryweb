using admin.libraryweb.Exceptions;
...
namespace admin.libraryweb.Infraestructure.ExternalServices.Library
{
    public class BookExternalService : IBookExternalService
    {
        ...
        public async Task<BookModel> Crear(CreateBookCommand model)
        {
            await ConfigureClient();
            ...
            BookModel response = await httpResult.Content.ReadFromJsonAsync<BookModel>();
            return response;
        }
